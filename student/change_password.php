            ...
            <article class="card-body mx-auto" style="max-width: 400px;">
                ...
                <form id="myform" action="change_pass.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group input-group">
                        ...
                        <input name="s_current_password" id="current_password" class="form-control" placeholder="Current password" minlength="8" maxlength="25" type="password">
                    </div> <!-- form-group// -->
                    <div class="form-group input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text"> <i class="fa fa-lock"></i> </span>
                        </div>
                        <input name="s_new_password" id="password" class="form-control" placeholder="New password" minlength="8" maxlength="25" type="password">
                    </div> <!-- form-group// -->
                    <div class="form-group input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text"> <i class="fa fa-lock"></i> </span>
                        </div>
                        <input name="s_repassword" id="repassword" class="form-control" placeholder="Repeat New password" type="password">
