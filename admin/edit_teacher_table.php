                    ...
                    <table class="table table-striped table-bordered" id="sortTable">
                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_array($qurey)) {
                                ...
                                echo '<td class="text-break">' . $row['st_address'] . '</td>';
                                echo '<td>' . $row['st_mobile'] . '</td>';
                                echo '<td>' . $row['st_email'] . '</td>';
                                echo '<td class="text-break">' . $row['st_document'] . '</td>';
                                echo '<td>' . $row['st_pincode'] . '</td>';
                                echo '<td>' . $row['st_create'] . '</td>';
                                echo '<td>' . $row['st_update'] . '</td>';
                                echo '<td class="">
                        <a class="btn btn-primary my-1 " href="edit_staff.php?id=' . $row['st_id'] . '">Edit</a></td>';
