                    ...
                    <table class="table table-striped table-bordered" id="sortTable">
                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_array($qurey)) {
                                ...
                                echo '<td class="text-break">' . $row['s_address'] . '</td>';
                                echo '<td>' . $row['s_pincode'] . '</td>';
                                echo '<td>' . $row['s_email'] . '</td>';
                                echo '<td class="text-break">' . $row['s_document'] . '</td>';
                                echo '<td>' . $row['s_active'] . '</td>';
                                echo '<td>' . $row['s_create'] . '</td>';
                                echo '<td>' . $row['s_update'] . '</td>';
                                echo '<td class="">
                        <a class="btn btn-primary my-1 " href="edit_std.php?id=' . $row['s_id'] . '">Edit</a></td>';
                                echo '<td class=""><a class="btn btn-danger my-1" href="delete_student_data.php?id=' . $row['s_id'] . '">Delete</a>
                        </td>';
                                echo '</tr>';
                            }
                            ?>
