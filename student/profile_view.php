                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                <?php echo "<img src='docs/" . $_SESSION['s_doc'] . "' alt='Student' class='rounded-circle' width='150'>" ?>
                                <div class="mt-3">
                                    <h4><?php echo $_SESSION['s_name']; ?></h4>
                                    <p class="text-secondary mb-1">Student</p>
                                    <p class="text-muted font-size-sm"><?php echo $_SESSION['s_address']; ?></p>
                                    <a href="edit_std.php" class="btn btn-success">Edit Profile</a>
