     ...
     <section class="navbar custom-navbar navbar-fixed-top" role="navigation">
          <div class="container">
               ...
               <div class="navbar-header">
                    ...
                    <!-- lOGO TEXT HERE -->
                    <a href="#" class="navbar-brand">Smart Learn</a>
               </div>
               ...
               <div class="collapse navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                         <li><a href="student/login.php" class="smoothScroll"> Start Learning</a></li>
                    </ul>
               </div>
                    ...
                    <div class="col-md-offset-1 col-md-4 col-sm-12">
                         <div class="entry-form">
                              <form action="student/home.php" method="post">
                                   ...
                                   <input type="email" name="s_email" class="form-control" placeholder="Your email address" required="">

                                   <input type="password" name="s_password" class="form-control" placeholder="Your password" required="">
     ...
     <section id="contact">
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                         <form id="contact-form" role="form" action="add_feedback.php" method="post">
                              <div class="section-title">
                              ...
                              if (isset($_SESSION['msg'])) {
                                   ...
                                   echo '<span class=""> ' . $_SESSION['msg'] . ' </span>';
                                   unset($_SESSION['msg']);
                              }
                              ?>
                              <div class="col-md-12 col-sm-12">
                              ...
                              <div class="col-md-4 col-sm-12">
                                   <input type="submit" class="form-control" name="feedback" value="Send Message">
                              </div>
                    ...
                    <div class="col-md-4 col-sm-6">
                         <div class="footer-info">
                              ...
                              <div class="copyright-text">
                                   <p>Copyright &copy; 2021 Smart Learn</p>

                                   <p>Design: Dev Patel | Poonam Prajapati</p>
                              </div>
                         </div>
                    </div>
