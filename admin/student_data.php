                    ...
                    <table class="table table-striped table-bordered" id="sortTable">
                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_array($qurey)) {
                                ...
                                echo '<td>' . $row['s_document'] . '</td>';
                                echo '<td>' . $row['s_active'] . '</td>';
                                echo '<td>' . $row['s_create'] . '</td>';
                                echo '<td>' . $row['s_update'] . '</td>';
                                echo '<td class="">
                        <a class="btn btn-primary my-1 " href="approve.php?id=' . $row['s_id'] . '">Approve</a>
                        <a class="btn btn-danger my-1" href="decline.php?id=' . $row['s_id'] . '">Decline</a>
                        </td>';
                                echo '</tr>';
                            }
                            ?>
